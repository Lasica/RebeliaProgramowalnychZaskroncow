...
Client::Client (Address address, ClientState state, TcpPointer pointer) :
    ClientDataRaw(state, Client::nextID_++), nickname_("NIE_MAM_NICKU"), address_(address), connection_(pointer)
