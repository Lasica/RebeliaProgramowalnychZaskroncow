...
numOfPlayers(0), id(GRId) { maxNumOfPlayers = 5; }   //id=0, bo ten konstruktor i tak jest wywoływany zawsze przez klasę GameRoom, gdzie to pole jest inicjalizowane z licznika
