...
short unsigned int Client::getPort() { return port; }

boost::asio::ip::address Client::getIp(){ return ip; }

std::string Client::getIpStr(){ return ip.boost::asio::ip::address::to_string(); }

statename Client::getState(){ return state; }

std::string Client::getGameID(){ return gameID; }

//set methods
void Client::setState(statename s){ state=s; }

void Client::setGameID(std::string id){ gameID=id; }
